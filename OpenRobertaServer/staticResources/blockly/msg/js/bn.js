...
Blockly.Msg.SENSOR_TAP = "accelerometer";  // untranslated
Blockly.Msg.SENSOR_TAP_GETSAMPLE_TOOLTIP = "Reads the current accelerometer values resulting from a tap/shock event.";  // untranslated
